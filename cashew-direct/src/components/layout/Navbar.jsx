            ...
            {isAuthenticated ? (
              <div className="relative hidden sm:block" ref={userMenuRef}>
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-100 text-sm font-bold text-brand-800 transition hover:bg-brand-200"
                  aria-label="Account menu"
                >
                  {initials}
                </button>
                {userMenuOpen && (
                  <div className="absolute right-0 top-[calc(100%+8px)] z-20 w-60 overflow-hidden rounded-xl border border-gray-200 bg-white py-2 shadow-lg">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 transition hover:bg-brand-50 hover:text-brand-800"
                    >
                    ...
                    <button
                      ...
                      className="flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-sm text-gray-700 transition hover:bg-red-50 hover:text-red-600"
                    >
              ...
              <Link
                to="/login"
                className="hidden h-10 items-center gap-1.5 rounded-lg border border-gray-200 px-3.5 text-sm font-semibold text-gray-700 transition hover:border-brand-300 hover:bg-brand-50 hover:text-brand-800 sm:flex"
              >
